...
const Navbar = () => {
  return (
    <header className='w-full bg-[#232f3f] '>
      <div className='w-full container py-2 px-5 flex justify-between  m-auto '>
      ...
      <div className='w-full px-10 py-5 flex gap-5 justify-between  m-auto'>
        <div className='flex items-center gap-10 grow'>
          ...
          <div className='flex h-full  max-h-[45px] w-full max-w-[700px]'>
      ...
      <div className='w-full flex px-10 m-auto'>
